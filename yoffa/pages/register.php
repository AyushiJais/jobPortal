...
<body id="top" background = "../images/demo/backgrounds/job_portal.jpg">
...
<div class="form-group">
  ...
  <div class="input-group">
  <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
  <input id="user_name" name="user_name" placeholder="Username" class="form-control"  type="text">
    </div>
  </div>
</div>
...
<div class="form-group">
  ...
  <input id="confirm_password" name="confirm_password" placeholder="Confirm Password" class="form-control"  type="password">
    ...
    <label class="error" id="pass2error">Hello mistake</label>
  </div>
</div>
...
<div class="form-group">
  ...
  <input id="contact_no" name="contact_no" placeholder="(639)" class="form-control" type="text">
    </div>
  </div>
</div>
