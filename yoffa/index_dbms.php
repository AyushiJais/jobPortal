...
<div class="topspacer bgded overlay" style="background-image:url('images/demo/backgrounds/job_portal.jpg');"> 
  <!-- ################################################################################################ -->
      ...
      <ul class="slides">
        <li>
          <article>
            ...
            <footer><a class="btn" href="pages/register.php">Get Started</a></footer>
          </article>
        </li>
        <li>
          <article>
